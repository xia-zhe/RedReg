...
class KS_dataset(Dataset): # 147
    ...
    def __init__(self, args, mode, select_ratio = 1, v_norm = True, a_norm = False, name = "KS"):
        ...
        if mode=='train':
            ...
            csv_path = '/C/BML/InfoReg_CVPR2025-main/data/ks/ks_train_overlap.txt'
            self.audio_path = '/C/BML/InfoReg_CVPR2025-main/data/ks/data/users/yake_wei/KS_2023/train_spec'
            self.visual_path = '/C/BML/InfoReg_CVPR2025-main/data/ks/data/users/yake_wei/KS_2023/train-frames-1fps/train'       
        elif mode=='val':
            ...
            csv_path = '/C/BML/InfoReg_CVPR2025-main/data/ks/data/users/yake_wei/KS_2023/ks_test_overlap.txt'
            self.audio_path = '/C/BML/InfoReg_CVPR2025-main/data/ks/data/users/yake_wei/KS_2023/test_spec'
            self.visual_path = '/C/BML/InfoReg_CVPR2025-main/data/ks/data/users/yake_wei/KS_2023/val-frames-1fps/test'
        else:
            # csv_path = '/data/users/yake_wei/KS_2023/ks_test_overlap.txt'
            # self.audio_path = '/data/users/yake_wei/KS_2023/test_spec'
            # self.visual_path = '/data/users/yake_wei/KS_2023/val-frames-1fps/test'
