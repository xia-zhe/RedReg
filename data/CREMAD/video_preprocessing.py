...
class videoReader(object):
    def __init__(self, video_path, frame_interval=1, frame_kept_per_second=3):
...
class CRAMED_dataset(object):
    def __init__(self, path_to_dataset = '/C/BML/InfoReg_CVPR2025-main/crema-d-mirror', frame_interval=1, frame_kept_per_second=4):
